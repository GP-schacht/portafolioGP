...
const links = [
  { label: 'LinkedIn',  href: 'www.linkedin.com/in/gael-pereira-561a95222', icon: `${base}/linkedin.svg`  },
  { label: 'GitHub',    href: 'https://github.com/GP-schacht',                        icon: `${base}/github.svg`    },
]
      ...
      <div className="rounded-2xl bg-secondary border border-primary/20 p-8 flex flex-col sm:flex-row items-center gap-8">
        ...
        <div className="flex-1">
          <p className="text-text/60 text-base leading-relaxed">
            ¿Tienes un proyecto en mente o quieres conversar? <br />
            <span className="text-primary font-medium">Dejame los detalles aqui.</span>
          </p>
          <a
        ...
        <div className="flex gap-3">
          {links.map(({ label, href, src }) => (
            <a
              ...
              className="group flex flex-col items-center gap-1.5 p-4 rounded-xl bg-background border border-primary/20 hover:border-primary hover:bg-primary/5 transition-all duration-200"
            >
